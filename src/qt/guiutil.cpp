...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("bitcoinhedge"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("bitcoinhedge://"))
    {
        uri.replace(0, 12, "bitcoinhedge:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("BitcoinHedge-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("BitcoinHedge-Qt"));
